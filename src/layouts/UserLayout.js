...
import { applyApprovalBadges } from 'src/navigation/applyApprovalBadges'
...
const UserLayout = ({ children, contentHeightFixed }) => {
  ...
  const verticalNavItems = useMemo(
    () => applyApprovalBadges(VerticalNavItems(), approvalCounts),
    [approvalCounts]
  )

  const horizontalNavItems = useMemo(
    () => applyApprovalBadges(HorizontalNavItems(), approvalCounts),
    [approvalCounts]
  )
