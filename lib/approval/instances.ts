...
export const pcrForecastWarrantyApprovalWorkflow = createApprovalWorkflow(PCR_FORECAST_WARRANTY_APPROVAL_CHAIN)

export const cannibalBaApprovalWorkflow = createApprovalWorkflow(CANNIBAL_BA_APPROVAL_CHAIN)

export function getPcrForecastApprovalWorkflow(isWarranty = false) {
  return isWarranty ? pcrForecastWarrantyApprovalWorkflow : pcrForecastApprovalWorkflow
}
